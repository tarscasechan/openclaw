...
- **refresh/sync/cache completion claims** → cite the updated artifact path plus command/log output; if missing, say “I attempted the refresh but haven’t verified completion yet”
