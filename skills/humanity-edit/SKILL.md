---
name: humanity-edit
description: Remove AI tells, Wikipedia tone, and over-shaped polish while keeping prose human and lived-in. Use after drafting and before tight line editing.
---
...
- Watch for abstract rewrites like "the author" or "users" when the human version is "I" or "you".
- Leave at least one human sentence intact if it carries the piece.
- If a line feels generated, cut or rewrite it.
- For direct edit requests, return the edited prose first, preferably by itself. Add explanation only if it helps the user understand a meaningful tradeoff.

## Output

A draft that feels lived-in, not synthetic.
