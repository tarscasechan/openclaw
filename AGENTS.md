...
- **refresh/sync/cache completion claims** → cite the updated artifact path plus command/log output; for contacts cache refresh, name the cache artifact/log or say “I attempted the contacts cache refresh but haven’t verified completion yet”
